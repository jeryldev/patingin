...
fn test_git_diff_with_empty_repository() {
    ...
    match result {
        Ok(diff_output) => {
            ...
            assert!(diff_output.is_empty() || diff_output.contains("no changes"), 
    ...
    match result {
        ...
        Err(e) => {
            ...
            assert!(
                ...
                "Error should mention git repository issue: {}", error_msg
            );
        }
    }
}
...
fn test_git_diff_with_invalid_commit_reference() {
    ...
    let result = GitDiffParser::execute_git_diff(&DiffScope::SinceCommit("nonexistent-commit".to_string()));
    ...
    match result {
        ...
        Err(e) => {
            ...
            assert!(
                ...
                "Error should mention invalid revision: {}", error_msg
            );
        }
    }
}
