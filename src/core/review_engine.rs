...
mod review_engine_tests {
    ...
    fn test_review_engine_performance() {
        ...
        let violations = engine
            .review_changed_lines("test.ex", &changed_lines)
    ...
    fn test_review_multiple_languages() {
        ...
        let elixir_lines = vec![ChangedLine {
            line_number: 10,
        ...
        let javascript_lines = vec![ChangedLine {
            line_number: 20,
        ...
        let elixir_violations = engine
            .review_changed_lines("lib/user.ex", &elixir_lines)
            .expect("Should review Elixir");
        let js_violations = engine
            .review_changed_lines("src/app.js", &javascript_lines)
...
+    atom = String.to_atom(dynamic_name)
    ...
    fn test_create_review_summary() {
        ...
        let violations = vec![ReviewViolation {
            rule: AntiPattern {
                id: "test1".to_string(),
